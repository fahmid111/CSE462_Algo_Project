...
public class ClusterEditingSolver {
    ...
    /**
     * Applies the block reduction to the graph.
     * Finds two nodes that are not neighbors and checks if they have less than 2 common neighbors.
     * an edge is blocked if the corresponding nodes have less than 2 common neighbors.
     */
    ...
    static Set<Edge> ce() {
        ...
        for (Graph g : components) {
           ...
           // System.out.println("Initial reduction");
            while (true) {
               // System.out.println("k->"+staticK);
           ...
           // System.out.println("Final Reduction");
            // improvements start
            int lower_bound = staticK;
            int upper_bound = upperBound - 1;
